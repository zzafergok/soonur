  ...
  theme: {
    extend: {
      colors: {
        ...
        // Countdown Theme (Option 3: Modern Red/Coral)
        countdown: {
          primary: '#e11d48', // Rose-600 (Vibrant Red/Pinkish)
          secondary: '#fda4af', // Rose-300 (Soft Coral/Pink)
          accent: '#fff1f2', // Rose-50 (Very light background tint)
          background: '#fff', // Pure white for cleanliness or very subtle off-white
        },
      },
